...
export async function GET(req){
    try {
        ...
        //mysql> select c.id as category_type, group_concat(distinct e.id order by e.id separator ',') as events, group_concat(DISTINCT p.id ORDER BY p.id separator ',') as properties from events e left join categories c on c.id = e.category_id left join category_properties p on c.id = p.category_id group by c.id;
