          ...
          <Card key={category.id} className="group relative overflow-hidden transition-all hover:shadow-lg">
            ...
            <div className="flex flex-col gap-3 p-4">
              <div className="flex flex-col items-center gap-2">
                ...
                <div className="flex w-full translate-y-2 items-center justify-around gap-0.5 opacity-0 transition-all duration-300 ease-out group-hover:translate-y-0 group-hover:opacity-100">
                  <Tooltip>
